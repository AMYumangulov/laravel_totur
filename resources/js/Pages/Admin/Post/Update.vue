<template>
    <div>
        ...
        <div class="mb-4">
            <img  class="border border-gray-200 w-1/3">
            <img :src="enteries.post.image_url" :alt="enteries.post.title">
        </div>
        ...
        <div class="mb-4">
            <a @click.prevent="updatePost" href="#"
               class="inline-block px-3 py-2 bg-emerald-700 text-white border border-emerald-800">Изменить</a>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        updatePost() {
            ...
            axios.post(route('admin.posts.update', { post: this.enteries.post.id }), formData, {
                    'headers': {
