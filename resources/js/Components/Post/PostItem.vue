                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <button @click="toggleLike(post.id)"
                            ...
                            <span v-if="post.liked_by_profiles_count > 0"
                                  class="ml-1 text-sm text-gray-500">{{ post.liked_by_profiles_count }}</span>
                        </button>
                    </div>
                </div>
...
export default {
    ...
    emits: ['post_deleted', 'like_toggled', 'get_post', 'isRepost', 'post_reposted'],
